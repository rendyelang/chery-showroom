    ...
    <section id="home" className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
        <motion.span
          ...
          className="inline-block py-1 px-3 border border-primary/30 rounded-full bg-black/30 backdrop-blur-md text-primary font-medium tracking-[0.2em] text-xs md:text-sm uppercase mb-6"
        >
          The Future of Mobility
        </motion.span>

        <motion.h1 initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.7, duration: 0.8 }} className="text-5xl md:text-8xl font-bold text-white mb-6 leading-tight">
          Dare to be <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-yellow-200">Different.</span>
        </motion.h1>

        <motion.p initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.9, duration: 0.8 }} className="text-gray-300 text-lg md:text-2xl mb-10 max-w-2xl mx-auto font-light leading-relaxed">
          Rasakan sensasi berkendara tanpa batas dengan teknologi EV terbaru. Mewah, Canggih, dan Futuristik.
        </motion.p>
